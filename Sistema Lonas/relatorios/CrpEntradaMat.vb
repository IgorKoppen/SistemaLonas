...
Public Class CrpEntradaMat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Lonas.CrpEntradaMat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpEntradaMat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpEntradaMat = New CrpEntradaMat()
        rpt.Site = Me.Site
        Return rpt
    End Function
