...
Public Class CrpEmbarcacao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Lonas.CrpEmbarcacao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpEmbarcacao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpEmbarcacao = New CrpEmbarcacao()
        rpt.Site = Me.Site
        Return rpt
    End Function
